...
const Footer = () => {
  return (
    <div className="relative h-45 w-screen bg-contain bg-no-repeat"
    style={{backgroundImage: `url(${bgImage})`,
    backgroundPosition: 'center', backgroundSize: 'cover'}}>

        <div className='absolute inset-0 backdrop-blur-[12px] bg-[linear-gradient(120deg,rgba(255,255,255,0.18),rgba(0,0,0,0.2))] shadow-lg text-center max-w-[100%] flex flex-col justify-center items-center gap-2'>
